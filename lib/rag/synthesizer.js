...
CRITICAL RULES:
1. **Grounding**: Use ONLY information from the CONTEXT. Extract and synthesize ALL relevant information from the CONTEXT to answer the question thoroughly. If the CONTEXT provides an answer (even partial), provide it with full citations. ONLY if the CONTEXT is completely silent on the question should you say you cannot answer.
