 ...
 * conversationHistory is an array of { role, content } optionally used to provide context.
 */
...
You will produce a concise helpful answer to the user's question. Start with the disclaimer:
"Disclaimer: Based on general knowledge (not verified sources). Please consult official sources for legal decisions."

If the recent conversation context is provided, use it to interpret follow-ups. The conversation (if any) is below:
...
`;
  try {
    ...
    // Extract URLs (regex). Keep unique.
