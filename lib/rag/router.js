...
export async function routeQuery(userQuery, conversationHistory = []) {
  ...
  const prompt = `
You are a lightweight "Router" assistant. For the given user query and recent conversation, produce:
1) a concise search-optimized refined_query (one line),
2) a single intent label from: question, follow_up, comparison, explain, procedural,
3) an output format from: short_answer, bullet_points, table, step_by_step.
